...
<div class="admin-main">
    <blockquote id="search" class="layui-elem-quote" style="position: relative;">
        <div class="layui-form-item" style="margin-bottom: 0;">
            ...
            <div class="layui-inline">
                <label class="layui-form-lab" style="width: auto">世代检索</label>
                <select name="generation_id" id="generation_id" style="height: 30px;width: 190px;float: right;"  class="layui-input layui-unselect tfield-all">
...
<script>
    ...
    function add(){
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/gen/member/toAdd.do',
            area: ['800px', '500px'],
            end: function () {
                location.reload();
            }
