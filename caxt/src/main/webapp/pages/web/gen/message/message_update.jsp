...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/message/update.do" id="form">
    <table width="90%">
        <tr>
            <td width="20%" align="right"><label class="layui-form-label">标题：</label></td>
            <td colspan="3"><input type="text" name="title" lay-verify="required" value="${p.title}" autocomplete="off" placeholder="请输入标题" class="layui-input"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"><textarea name="content" id="content" placeholder="请输入内容" class="layui-textarea" style=" margin: 0 0 10px;min-height: 320px;">${p.content}</textarea></td>
        </tr>
        <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/gen/message/update.do",data.field,function(res){
                if (res.success) {
