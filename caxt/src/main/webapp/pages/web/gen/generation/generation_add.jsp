...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/generation/save.do" id="form">
<table width="90%">
    <tr>
    ...
    <tr>
        ...
        <td colspan="3"><input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入名称" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">世代顺序：</label></td>
        <td colspan="3"><input type="text" name="gorder" lay-verify="required" autocomplete="off" placeholder="请输入世代顺序" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">世代辈分：</label></td>
        <td colspan="3"><input type="text" name="seniority" lay-verify="" autocomplete="off" placeholder="请输入世代辈分" class="layui-input"></td>
    </tr>
    <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/gen/generation/save.do",data.field,function(res){
                if (res.success) {
