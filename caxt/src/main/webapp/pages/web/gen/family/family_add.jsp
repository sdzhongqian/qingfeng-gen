...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/family/save.do" id="form">
<table width="90%">
    <tr>
    ...
    <tr>
        ...
        <td colspan="3"><input type="text" name="first_name" lay-verify="required" autocomplete="off" placeholder="请输入姓氏" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">家传：</label></td>
        <td colspan="3"><input type="text" name="biography" lay-verify="" autocomplete="off" placeholder="请输入家传" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">家训：</label></td>
        <td colspan="3"><input type="text" name="training" lay-verify="" autocomplete="off" placeholder="请输入家训" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">辈分字：</label></td>
        <td colspan="3"><input type="text" name="senior" lay-verify="" autocomplete="off" placeholder="请输入辈分字" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">所在地：</label></td>
        <td colspan="3"><input type="text" name="address" lay-verify="title" autocomplete="off" placeholder="请输入所在地" class="layui-input"></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">家谱维护人：</label></td>
        <td colspan="3"><input type="text" name="maintainer" lay-verify="title" autocomplete="off" placeholder="请输入家谱维护人" class="layui-input"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3"><textarea name="his_intro" placeholder="请输入历史渊源" lay-verify="remark" class="layui-textarea" style=" margin: 0 0 10px;"></textarea></td>
    </tr>
    <tr>
        <td width="20%" align="right"><label class="layui-form-label">姓氏源流：</label></td>
        <td colspan="3"><textarea name="source" placeholder="请输入姓氏源流" lay-verify="remark" class="layui-textarea" style=" margin: 0 0 10px;"></textarea></td>
    </tr>
    <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/gen/family/save.do",data.field,function(res){
                if (res.success) {
