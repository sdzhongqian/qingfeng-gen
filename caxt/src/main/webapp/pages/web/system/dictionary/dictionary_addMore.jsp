...
<table class="layui-table">
    ...
    <tbody id="table">
        <tr>
            ...
            <td><input type="text" name="name" lay-verify="required|title" autocomplete="off" placeholder="请输入字典名称" class="layui-input"></td>
            <td><input type="text" name="short_name" lay-verify="title" autocomplete="off" placeholder="请输入字典简称" class="layui-input"></td>
...
//            })
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/dictionary/saveMore.do" ,//url
                data: $('#form').serialize(),
            ...
            <%--$.post("${pageContext.request.contextPath}/system/dictionary/saveMore.do",data.field,function(res){--%>
                <%--layer.msg("数据保存成功。", {time: 2000});--%>
    ...
    function addLine(){
        ...
        var tt = '<tr id="tr_'+index+'">';
            ...
            tt += '<td><input type="text" name="name" lay-verify="required|title" autocomplete="off" placeholder="请输入字典名称" class="layui-input"></td>';
            tt += '<td><input type="text" name="short_name" lay-verify="title" autocomplete="off" placeholder="请输入字典简称" class="layui-input"></td>';
