...
<table class="layui-table">
    ...
    <tbody id="table">
        <tr>
            ...
            <td><input type="text" name="name" lay-verify="required|title" autocomplete="off" placeholder="请输入名称" class="layui-input"></td>
            <td><input type="text" name="code" lay-verify="title" autocomplete="off" placeholder="请输入编号" class="layui-input"></td>
            <td>
            ...
            <td><input type="text" name="icon" lay-verify="title" autocomplete="off" placeholder="请输入icon" class="layui-input"></td>
...
//            })
            ...
            $.ajax({
                ...
                url: "${pageContext.request.contextPath}/system/menu/saveMore.do" ,//url
                data: $('#form').serialize(),
            ...
            <%--$.post("${pageContext.request.contextPath}/system/menu/saveMore.do",data.field,function(res){--%>
                <%--layer.msg("数据保存成功。", {time: 2000});--%>
    ...
    function addLine(){
        ...
        var tt = '<tr id="tr_'+index+'">';
            ...
            tt += '<td><input type="text" name="name" lay-verify="required|title" autocomplete="off" placeholder="请输入名称" class="layui-input"></td>';
            tt += '<td><input type="text" name="code" lay-verify="title" autocomplete="off" placeholder="请输入编号" class="layui-input"></td>';
            tt += '<td><select name="classify" lay-verify="required"><option value="0">系统菜单</option><option value="1">自定义菜单</option></select></td>';
            tt += '<td><input type="text" name="url" lay-verify="title" autocomplete="off" placeholder="请输入URL" class="layui-input"></td>';
            tt += '<td><input type="text" name="icon" lay-verify="title" autocomplete="off" placeholder="请输入icon" class="layui-input"></td>';
