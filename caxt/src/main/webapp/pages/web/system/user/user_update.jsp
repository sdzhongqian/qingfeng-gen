...
<form class="layui-form" action="${pageContext.request.contextPath}/system/user/update.do" id="form">
    <table width="90%">
        ...
        <tr>
            ...
            <td><input type="tel" name="phone" lay-verify="phone" autocomplete="off" placeholder="请输入手机号码" value="${p.phone}" class="layui-input"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <input type="text" readonly autocomplete="off" id="organize_name" name="organize_name" placeholder="请选择组织名称" value="${p.organize_name}" class="layui-input" onclick="showMenu('organize_name','organize_id');">
                <input type="hidden" name="organize_id" id="organize_id" value="${p.organize_id}" readonly autocomplete="off" placeholder="请输入组织" class="layui-input">
            </td>
        </tr>
        <tr>
