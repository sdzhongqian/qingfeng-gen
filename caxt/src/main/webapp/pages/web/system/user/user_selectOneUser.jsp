    ...
    <div align="center">
        ...
        <div style="float: left;width: 68%;height: 320px;">
            ...
            <div style="border: 1px solid grey;height: 198px;border-radius:8px 8px 8px 8px;">
                <div align="center" class="label-title">选择用户</div>
                <ul id="listUser">
                </ul>
            </div>
            ...
            success: function (res) {
                if(res.success){
                    ...
                    $.each(res.data,function(i,n){
                        tt+='<li class="label-li"><input type="radio" id="user_'+ n.id+'" name="user" value="'+n.id+'" onclick="checkUser(\''+ n.id+'\',\''+ n.nickname+'\')" style="display: inline-block" title="'+n.nickname+'">'+n.nickname+'</li>';
                    });
                    $("#listUser").html(tt);
                    for(var i=0; i< ids.length; i++) {
                        if (ids[i] != '' && ids[i] != null) {
